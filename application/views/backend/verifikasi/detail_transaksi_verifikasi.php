        ...
        <div class="page-header">
            ...
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('AdminViewTransaksi');?>" class="breadcrumb-link">Laporan Transaksi</a></li>
                        ...
                        <form method="post" action="<?= site_url('AdminViewTransaksi/proses_edit_detail/'.$item->id_transaksi);?>">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>Rp <?php echo number_format($item->total_harga+$item->kode_unik, 0,",","."); ?></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="col-sm-3">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-center"><button disabled class="btn btn-danger">Simpan</button>
                                    </td>
                                    <?php } else {?>
                                    <td colspan="2" class="text-center"><button class="btn btn-danger">Simpan</button>
                                    </td>
                                    <?php } ?>
                                </tr>
                            </table> 
