            ...
            <section id="do_action">
                <div class="container col-sm-12">
                    <div style="padding-bottom: 10px">
                        <a href="<?= site_url('komplain/komplain_saya'); ?>" class="btn btn-outline-brand" ><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <?php if(is_null($data->balasan)){?>
                                                <td align="right"><p style="color: #A9A9A9;"><i>belum ada balasan</i></p></td>
                                            <?php }else {?>
