<div class="col-sm-9 padding-right" >
    <div class="features_items"><!--features_items-->
        <h2 class="title text-center">Laporan Penjualan</h2>
        <div class="row">

        <div class="col-lg-12">
            <form action="<?= site_url('reportpenjualan/filterdate') ?>" method="get">
                <div class="row">
                    <div class="col-xs-3">
                    </div>
            ...
            <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered second" style="width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td colspan="5" class="text-center"><h5>Belum ada transaksi yang selesai!</h5></td>
                        </tr>
                        <?php  
                            } else{
                ...
                <a href="<?= site_url('reportpenjualan/cetak');?>" class="btn btn-info">Export to PDF</a>
            </div>
        </div> <!-- /.col-lg-12 -->       
    </div><!--features_items-->  
    </div>
