                            ...
                            <ul class="user_info">
                                ...
                                <form method="get" action="<?= site_url('komplain/tulis/'.$item->id_barang);?>">
                                    <tr>
                                        ...
                                        <!-- <?php if($item->status_barang !== 'Sudah Diterima'){?>
                                        <td class="cart_price text-center">
                                            <input hidden type="text" name="id_transaksi" value="<?= $item->id_transaksi;?>">
                                            <button type="submit" class="btn btn-danger">Komplain</button>
                                        </td>
                                        <?php } else {?> -->
                                        <td>
                                            <input hidden type="text" name="id_transaksi" value="<?= $item->id_transaksi;?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6">
                                                    <button type="submit" name="action" value="Review" class="btn btn-primary btn-xs">Review</button>
                                                </div>
                                            </div>
                                        </td>
                                        <!-- <?php } ?> -->
