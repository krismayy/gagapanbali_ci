<div class="col-sm-9 padding-right" >
    <div class="features_items"><!--features_items-->
        <h2 class="title text-center">Pesanan Selesai</h2>
        <?= $this->session->flashdata('success');?>

        <?php if(is_null($pembelian)){ ?>
            <div class='alert alert-info'>Belum ada pesanan yang diterima!</div>
        <?php } else {  
            $id_transaksi ="";
                ...
                <div class="table-responsive chose_area" style="word-wrap: break-word;">
                    ...
                    <div class="row">
                        <div align="right" style="margin-top: 5px">
                            <a href="<?= site_url('pesanan/detail_pesanan_selesai/'.$item['id_transaksi']);?>" class="btn btn-default">Detail Pesanan</a>
                        </div>
                    </div>
                </div>
            </div>
